...
public class Trie {
  ...
  /**
   * Recursively gets led between two words. 
   *
   * @param word1
   *          First word
   * @param word2
  ...
  public static int getLedDistance(String word1, String word2) {
    ...
    int substitutionCost = word1.charAt(0) == word2.charAt(0) ? 0 : 1;
    int substitution = getLedDistance(word1.substring(1), word2.substring(1)) + substitutionCost;
    int insertion = getLedDistance(word1, word2.substring(1)) + 1;
    int deletion = getLedDistance(word1.substring(1), word2) + 1;
